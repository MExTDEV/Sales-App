...
const titleKeys: Record<AppView, string> = {
  ...
  reports: "nav.reports",
  pst: "nav.pst",
  pstDashboard: "pst.nav.dashboard",
  pstSegments: "pst.nav.segments",
  pstRoutes: "pst.nav.routes",
  pstProspection: "pst.nav.prospection",
  pstMaps: "pst.nav.maps",
  pstApprovals: "pst.nav.approvals",
  pstRepresentatives: "pst.nav.representatives",
  pstPlanning: "pst.nav.planning",
  pstQuality: "pst.nav.quality",
  service: "nav.service",
